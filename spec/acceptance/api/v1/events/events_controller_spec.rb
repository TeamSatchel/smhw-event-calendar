  ...
  describe "GET #index" do
    context "when success" do
      ...
      it "render an array of events with particular event" do
        ...
        expect(json_event['start_date'].to_datetime.to_i).to eql @event_1.start_date.to_i
        expect(json_event['end_date'].to_datetime.to_i).to eql @event_1.end_date.to_i
  ...
  describe "POST #create" do
    ...
    context "when is successfully created" do
      ...
      it "render created event" do
        ...
        expect(json_data['start_date'].to_datetime.to_i).to eql @event_attributes[:start_date].to_datetime.to_i
        expect(json_data['end_date'].to_datetime.to_i).to eql @event_attributes[:end_date].to_datetime.to_i
    ...
    context "when has error" do
      it "render unprocessable_entity error when required event param is missing or empty" do
        ...
        expect(json_response['meta']['message'].downcase).to include "title"
      end
    end
  end
end
